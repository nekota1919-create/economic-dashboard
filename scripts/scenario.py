...
MARKET_TEMPLATES: dict[str, dict[str, str]] = {
    ...
    "us_pce": {
        "higher_is": "インフレ加速(タカ派材料、Fedが最重視する指標)",
        "lower_is": "インフレ鈍化(ハト派材料)",
        "beat": "予想を上回った場合、Fedの利下げ観測が後退しやすく、ドル高(円安)に振れやすいとされる",
        "miss": "予想を下回った場合、利下げ観測が強まりやすく、ドル安(円高)に振れやすいとされる",
    },
    "us_ppi": {
        "higher_is": "川上インフレ圧力の高まり(タカ派材料)",
        "lower_is": "川上インフレ圧力の後退(ハト派材料)",
        "beat": "予想を上回った場合、先行きCPIへの波及が意識されドル高(円安)に振れやすいとされる",
        "miss": "予想を下回った場合、インフレ鈍化観測からドル安(円高)に振れやすいとされる",
    },
    "us_retail_sales": {
        "higher_is": "個人消費の強さ(タカ派材料)",
        "lower_is": "個人消費の弱さ(ハト派材料)",
        "beat": "予想を上回った場合、景気の底堅さが意識されドル高(円安)に振れやすいとされる",
        "miss": "予想を下回った場合、景気減速懸念からドル安(円高)に振れやすいとされる",
    },
    "us_jobless_claims": {
        "higher_is": "労働市場の悪化(ハト派材料)",
        "lower_is": "労働市場の改善(タカ派材料)",
        "beat": "予想より少ない(改善)場合、ドル高(円安)方向に振れやすいとされる",
        "miss": "予想より多い(悪化)場合、ドル安(円高)方向に振れやすいとされる",
    },
    "us_michigan_sentiment": {
        "higher_is": "消費者心理の改善",
        "lower_is": "消費者心理の悪化",
        "beat": "予想を上回った場合、消費の先行き期待からドル高(円安)に振れやすいとされる",
        "miss": "予想を下回った場合、先行き懸念からドル安(円高)に振れやすいとされる",
    },
    "us_gdp": {
        "higher_is": "景気拡大の強さ(タカ派材料)",
        "lower_is": "景気減速(ハト派材料)",
        "beat": "予想を上回った場合、経済の強さが意識されドル高(円安)に振れやすいとされる",
        "miss": "予想を下回った場合、景気減速懸念からドル安(円高)に振れやすいとされる",
    },
    "ecb_rate": {
        "higher_is": "利上げ(タカ派)",
        "lower_is": "利下げ/据置(ハト派)",
        "beat": "予想よりタカ派な決定の場合、ユーロ高に振れやすいとされる",
        "miss": "予想よりハト派な決定の場合、ユーロ安に振れやすいとされる",
    },
    "boe_rate": {
        "higher_is": "利上げ(タカ派)",
        "lower_is": "利下げ/据置(ハト派)",
        "beat": "予想よりタカ派な決定の場合、ポンド高に振れやすいとされる",
        "miss": "予想よりハト派な決定の場合、ポンド安に振れやすいとされる",
    },
}
